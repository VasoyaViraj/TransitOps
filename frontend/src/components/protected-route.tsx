...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children, permission }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center">
        <Loader2 className="w-8 h-8 text-[#3ecf8e] animate-spin mb-4" />
  ...
  if (permission && !hasPermission(permission.module, permission.level)) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center bg-white border border-[#dfdfdf] rounded-lg">
        ...
        <h2 className="text-xl font-bold text-[#171717] tracking-tight">Access Denied</h2>
