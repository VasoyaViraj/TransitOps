...
export const Settings: React.FC = () => {
  ...
  const selectCls = "bg-white text-xs px-2 py-1 rounded border border-[#E2E8F0] focus:border-[#2563EB] focus:outline-none cursor-pointer";
  const inputCls = "w-full bg-[#F8FAFC] text-sm px-3 py-2 rounded-md border border-[#E2E8F0] focus:border-[#2563EB] focus:outline-none";

  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-[#0F172A] tracking-tight">System Settings & RBAC</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-lg p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-[#0F172A] uppercase tracking-wider mb-5">General Settings</h3>
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold text-xs py-2.5 rounded-md shadow-sm transition-colors flex items-center justify-center gap-2"
            >
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-lg p-6 shadow-sm">
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-sm font-semibold text-[#0F172A] uppercase tracking-wider">Role-Based Access Control (RBAC)</h3>
            {isAdmin && (
            ...
            <div className="space-y-5">
              {permissions.map((row, roleIdx) => (
                <div key={row.role} className="border border-gray-100 rounded-lg p-4">
                  <h4 className="text-xs font-bold text-[#0F172A] uppercase tracking-wider mb-3">{formatRole(row.role)}</h4>
                  ...
                  <button
                    ...
                    className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold text-[10px] py-1.5 rounded-md transition-colors disabled:opacity-60 flex items-center justify-center gap-1"
                  >
      ...
      {isAdmin && (
        <div className="bg-white border border-[#E2E8F0] rounded-lg p-6 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-sm font-semibold text-[#0F172A] mb-1">Admin Access</h4>
